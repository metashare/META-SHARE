...
from metashare.repo2 import views
...
def _import_resource(fixture_name):
    ...
    """
    _result = test_utils.import_xml('{0}/repo2/fixtures/{1}'
...
class DownloadViewTest(TestCase):
    ...
    def test_non_downloadable_resource(self):
        ...
        response = client.get(
            ...
            follow = True)
        self.assertTemplateUsed(response, 'repo2/lr_not_downloadable.html')
    ...
    def _test_downloadable_resource_with_one_license(self, client):
        ...
        response = client.get(
            ...
            follow = True)
        self.assertTemplateUsed(response, 'repo2/licence_agreement.html',
        ...
        response = client.post(
            ...
            { 'in_licence_agree_form': 'True', 'licence_agree': 'True',
              'licence': 'CC_BY-NC-SA' },
            follow = True)
        self.assertTemplateNotUsed(response, 'repo2/licence_agreement.html',
                            msg_prefix="a download should have been started")
        self.assertTemplateNotUsed(response, 'repo2/licence_selection.html',
                            msg_prefix="a download should have been started")
        self.assertTemplateNotUsed(response, 'repo2/lr_not_downloadable.html',
                            msg_prefix="a download should have been started")
