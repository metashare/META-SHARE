...
LOGGER = logging.getLogger('metashare.repo2.widgets')
...
class MultiFieldWidget(widgets.Widget):
    ...
    def render(self, name, value, attrs=None):
        ...
        for _id, _value in enumerate(value):
            ...
            _container = render_to_string('repo2/container.html', _context)
        ...
        _html = render_to_string('repo2/multi_field_widget.html', _context)
