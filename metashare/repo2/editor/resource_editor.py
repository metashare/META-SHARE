...
class ResourceComponentInline(ReverseInlineModelAdmin):
    ...
    def __init__(self,
        ...
        self.template = 'repo2/editor/resourceComponentInline.html'
...
class ResourceModelAdmin(ReverseModelAdmin):
    ...
    def resource_type_selection_view(self, request, form_url, extra_context):
        ...
        return render_to_response("repo2/editor/select_resource_type.html", context, RequestContext(request))
