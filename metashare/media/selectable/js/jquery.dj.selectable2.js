 ...
 *
*/
alert('django selectable script');
(function($) {

	alert('django selectable init');
...
alert('django selectable: before bindSelectables');
...
alert('django selectable: before 1');
...
alert('django selectable: before 2');
