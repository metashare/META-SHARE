...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for operation_info in orm.toolServiceOperationInfoType_model.objects.iterator():
            operation_info.operatingSystem = operation_info.operatingSystem_old
            operation_info.save()
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'1ae062aed49c11e59e77f04da2da8af87f2ece012f4a4f94b4195f4c6c393778'", 'unique': 'True', 'max_length': '64'}),
