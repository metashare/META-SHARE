...
COUNTRY_MAP = {u'M': u'Malta', u'USA': u'United States', u'Brasil': u'Brazil',
               u'Polska': u'Poland', u'U.S.A.': u'United States', u'DE': u'Germany',
               u'EUA': u'United States', u'IT': u'Italy', u'HU': u'Hungary',
               u'Rom\xe2nia': u'Romania', u'Italia': u'Italy', u'SPAIN': u'Spain',
               u'UK': u'United Kingdom', u'Finland and Denmark': u'Finland',
               u'Russia': u'Russian Federation', u'PL': u'Poland', u'GR': u'Greece',
               u'EU': u'European Union', u'European Comission': u'European Union',
               u'Denamrk': u'Denmark', u'The Netherlands': u'Netherlands',
               u'NO': u'Norway', u'the Netherlands': u'Netherlands'}

DEFAULT_VALUE = u'Private use'

class Migration(DataMigration):

    def forwards(self, orm):
        # Validate and update country and funidingCountry values.
        ...
        for project_info in orm.projectInfoType_model.objects.iterator():
            ...
            for country in project_info.fundingCountry:
                if fundingCountry_choices.get(country):
                    ...
                    write_to_resources_to_be_modified_file(_file, project_info,
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'74450c06d93711e59417f04da2da8af8879acd9afa7641d0bfc8cd140a5d37bb'", 'unique': 'True', 'max_length': '64'}),
