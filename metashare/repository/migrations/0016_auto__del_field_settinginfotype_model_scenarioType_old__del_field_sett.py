...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'settingInfoType_model.scenarioType_old'
        db.delete_column('repository_settinginfotype_model', 'scenarioType_old')

        # Deleting field 'settingInfoType_model.conversationalType_old'
        db.delete_column('repository_settinginfotype_model', 'conversationalType_old')


    def backwards(self, orm):
        # Adding field 'settingInfoType_model.scenarioType_old'
        db.add_column('repository_settinginfotype_model', 'scenarioType_old',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'settingInfoType_model.conversationalType_old'
        db.add_column('repository_settinginfotype_model', 'conversationalType_old',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'1a238256d4a111e591e1f04da2da8af81cde72cb03504980a31ecaacde43e671'", 'unique': 'True', 'max_length': '64'}),
