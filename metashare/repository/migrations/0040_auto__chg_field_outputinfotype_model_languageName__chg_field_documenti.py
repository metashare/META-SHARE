...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('repository_documentinfotype_model', 'documentLanguageName', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'annotationInfoType_model.tagsetLanguageName'
        db.alter_column('repository_annotationinfotype_model', 'tagsetLanguageName', self.gf('django.db.models.fields.CharField')(max_length=100))
        ...
        db.add_column('repository_languageinfotype_model', 'variant',
                      self.gf('metashare.repository.fields.MultiTextField')(max_length=500, null=True, blank=True),
                      keep_default=False)
