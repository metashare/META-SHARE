...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'outputInfoType_model.languageName'
        db.alter_column('repository_outputinfotype_model', 'languageName', self.gf('metashare.repository.fields.MultiTextField')(max_length=1000))

        # Changing field 'documentInfoType_model.documentLanguageName'
        db.alter_column('repository_documentinfotype_model', 'documentLanguageName', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'annotationInfoType_model.tagsetLanguageName'
        db.alter_column('repository_annotationinfotype_model', 'tagsetLanguageName', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'inputInfoType_model.languageName'
        db.alter_column('repository_inputinfotype_model', 'languageName', self.gf('metashare.repository.fields.MultiTextField')(max_length=1000))
        # Adding field 'languageInfoType_model.region'
        db.add_column('repository_languageinfotype_model', 'region',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'languageInfoType_model.variant'
        db.add_column('repository_languageinfotype_model', 'variant',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=1000, blank=True),
                      keep_default=False)


        # Changing field 'languageInfoType_model.languageName'
        db.alter_column('repository_languageinfotype_model', 'languageName', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'metadataInfoType_model.metadataLanguageName'
        db.alter_column('repository_metadatainfotype_model', 'metadataLanguageName', self.gf('metashare.repository.fields.MultiTextField')(max_length=1000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'documentInfoType_model.documentLanguageName'
        db.alter_column('repository_documentinfotype_model', 'documentLanguageName', self.gf('metashare.repository.fields.XmlCharField')(max_length=150))

        # Changing field 'annotationInfoType_model.tagsetLanguageName'
        db.alter_column('repository_annotationinfotype_model', 'tagsetLanguageName', self.gf('metashare.repository.fields.XmlCharField')(max_length=100))

        # Changing field 'inputInfoType_model.languageName'
        db.alter_column('repository_inputinfotype_model', 'languageName', self.gf('metashare.repository.fields.MultiTextField')(max_length=1000))
        # Deleting field 'languageInfoType_model.region'
        db.delete_column('repository_languageinfotype_model', 'region')

        # Deleting field 'languageInfoType_model.variant'
        db.delete_column('repository_languageinfotype_model', 'variant')


        # Changing field 'languageInfoType_model.languageName'
        db.alter_column('repository_languageinfotype_model', 'languageName', self.gf('metashare.repository.fields.XmlCharField')(max_length=100))
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'ab3831b6d93c11e5b101f04da2da8af8003a3de251064549a0fd790766619845'", 'unique': 'True', 'max_length': '64'}),
