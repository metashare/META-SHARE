...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'licenceInfoType_model.licence'
        db.add_column('repository_licenceinfotype_model', 'licence',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.version'
        db.add_column('repository_licenceinfotype_model', 'version',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.nonStandardLicenceName'
        db.add_column('repository_licenceinfotype_model', 'nonStandardLicenceName',
                      self.gf('metashare.repository.fields.DictField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.nonStandardLicenceTermsURL'
        db.add_column('repository_licenceinfotype_model', 'nonStandardLicenceTermsURL',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.nonStandaradLicenceTermsText'
        db.add_column('repository_licenceinfotype_model', 'nonStandaradLicenceTermsText',
                      self.gf('metashare.repository.fields.DictField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.restrictionsOfUse'
        db.add_column('repository_licenceinfotype_model', 'restrictionsOfUse',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'attribution', u'Attribution'), (u'nonCommercialUse', u'Non Commercial Use'), (u'commercialUse', u'Commercial Use'), (u'shareAlike', u'Share Alike'), (u'noDerivatives', u'No Derivatives'), (u'noRedistribution', u'No Redistribution'), (u'evaluationUse', u'Evaluation Use'), (u'research', u'Research'), (u'languageEngineeringResearch', u'Language Engineering Research'), (u'education', u'Education'), (u'informLicensor', u'Inform Licensor'), (u'redeposit', u'Redeposit'), (u'compensate', u'Compensate'), (u'personalDataIncluded', u'Personal Data Included'), (u'sensitiveDataIncluded', u'Sensitive Data Included'), (u'requestPlan', u'Request Plan'), (u'spatialConstraint', u'Spatial Constraint'), (u'userIdentified', u'User Identified'), (u'other', u'Other')), max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'distributionInfoType_model.distributionAccessMedium'
        db.add_column('repository_distributioninfotype_model', 'distributionAccessMedium',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'webExecutable', u'Web Executable'), (u'paperCopy', u'Paper Copy'), (u'hardDisk', u'Hard Disk'), (u'bluRay', u'Blu Ray'), (u'DVD-R', u'DVD - R'), (u'CD-ROM', u'CD - ROM'), (u'downloadable', u'Downloadable'), (u'accessibleThroughInterface', u'Accessible Through Interface'), (u'other', u'Other')), max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'distributionInfoType_model.downloadLocation'
        db.add_column('repository_distributioninfotype_model', 'downloadLocation',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'distributionInfoType_model.executionLocation'
        db.add_column('repository_distributioninfotype_model', 'executionLocation',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'distributionInfoType_model.attributionText'
        db.add_column('repository_distributioninfotype_model', 'attributionText',
                      self.gf('metashare.repository.fields.DictField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'distributionInfoType_model.fee'
        db.add_column('repository_distributioninfotype_model', 'fee',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'distributionInfoType_model.userNature'
        db.add_column('repository_distributioninfotype_model', 'userNature',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'academic', u'Academic'), (u'commercial', u'Commercial')), max_length=1, blank=True),
                      keep_default=False)

        # Adding M2M table for field licenceInfo on 'distributionInfoType_model'
        m2m_table_name = db.shorten_name('repository_distributioninfotype_model_licenceInfo')
        ...
        db.create_unique(m2m_table_name, ['distributioninfotype_model_id', 'licenceinfotype_model_id'])

        # Adding M2M table for field licensor on 'distributionInfoType_model'
        m2m_table_name = db.shorten_name('repository_distributioninfotype_model_licensor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('distributioninfotype_model', models.ForeignKey(orm['repository.distributioninfotype_model'], null=False)),
        ...
        # Adding M2M table for field distributionRightsHolder on 'distributionInfoType_model'
        m2m_table_name = db.shorten_name('repository_distributioninfotype_model_distributionRightsHolder')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('distributioninfotype_model', models.ForeignKey(orm['repository.distributioninfotype_model'], null=False)),
            ('actorinfotype_model', models.ForeignKey(orm['repository.actorinfotype_model'], null=False))
        ...
        # Adding M2M table for field membershipInfo on 'distributionInfoType_model'
        m2m_table_name = db.shorten_name('repository_distributioninfotype_model_membershipInfo')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('distributioninfotype_model', models.ForeignKey(orm['repository.distributioninfotype_model'], null=False)),
            ('membershipinfotype_model', models.ForeignKey(orm['repository.membershipinfotype_model'], null=False))
        ))
        db.create_unique(m2m_table_name, ['distributioninfotype_model_id', 'membershipinfotype_model_id'])


    def backwards(self, orm):
        # Deleting field 'licenceInfoType_model.licence'
        db.delete_column('repository_licenceinfotype_model', 'licence')

        # Deleting field 'licenceInfoType_model.version'
        db.delete_column('repository_licenceinfotype_model', 'version')

        # Deleting field 'licenceInfoType_model.nonStandardLicenceName'
        db.delete_column('repository_licenceinfotype_model', 'nonStandardLicenceName')

        # Deleting field 'licenceInfoType_model.nonStandardLicenceTermsURL'
        db.delete_column('repository_licenceinfotype_model', 'nonStandardLicenceTermsURL')

        # Deleting field 'licenceInfoType_model.nonStandaradLicenceTermsText'
        db.delete_column('repository_licenceinfotype_model', 'nonStandaradLicenceTermsText')

        # Deleting field 'licenceInfoType_model.restrictionsOfUse'
        db.delete_column('repository_licenceinfotype_model', 'restrictionsOfUse')

        # Deleting field 'distributionInfoType_model.distributionAccessMedium'
        db.delete_column('repository_distributioninfotype_model', 'distributionAccessMedium')

        # Deleting field 'distributionInfoType_model.downloadLocation'
        db.delete_column('repository_distributioninfotype_model', 'downloadLocation')

        # Deleting field 'distributionInfoType_model.executionLocation'
        db.delete_column('repository_distributioninfotype_model', 'executionLocation')

        # Deleting field 'distributionInfoType_model.attributionText'
        db.delete_column('repository_distributioninfotype_model', 'attributionText')

        # Deleting field 'distributionInfoType_model.fee'
        db.delete_column('repository_distributioninfotype_model', 'fee')

        # Deleting field 'distributionInfoType_model.userNature'
        db.delete_column('repository_distributioninfotype_model', 'userNature')

        # Removing M2M table for field licenceInfo on 'distributionInfoType_model'
        db.delete_table(db.shorten_name('repository_distributioninfotype_model_licenceInfo'))

        # Removing M2M table for field licensor on 'distributionInfoType_model'
        db.delete_table(db.shorten_name('repository_distributioninfotype_model_licensor'))

        # Removing M2M table for field distributionRightsHolder on 'distributionInfoType_model'
        db.delete_table(db.shorten_name('repository_distributioninfotype_model_distributionRightsHolder'))

        # Removing M2M table for field membershipInfo on 'distributionInfoType_model'
        db.delete_table(db.shorten_name('repository_distributioninfotype_model_membershipInfo'))
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'c59865d4d96511e5bc67f04da2da8af8b5f87afb88fb400aa687639b1b1dc3b7'", 'unique': 'True', 'max_length': '64'}),
