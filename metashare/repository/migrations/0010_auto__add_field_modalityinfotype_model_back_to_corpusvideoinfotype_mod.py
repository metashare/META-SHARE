...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'modalityInfoType_model.back_to_corpusvideoinfotype_model'
        db.add_column('repository_modalityinfotype_model', 'back_to_corpusvideoinfotype_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.corpusVideoInfoType_model'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'modalityInfoType_model.back_to_corpusvideoinfotype_model'
        db.delete_column('repository_modalityinfotype_model', 'back_to_corpusvideoinfotype_model_id')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'283a3040d49e11e5a31ef04da2da8af894226bda7f4f465c892ebdfa4eb7ca15'", 'unique': 'True', 'max_length': '64'}),
