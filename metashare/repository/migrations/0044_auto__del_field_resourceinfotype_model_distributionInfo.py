...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'resourceInfoType_model.distributionInfo'
        db.delete_column('repository_resourceinfotype_model', 'distributionInfo_id')


    def backwards(self, orm):
        # Adding field 'resourceInfoType_model.distributionInfo'
        db.add_column('repository_resourceinfotype_model', 'distributionInfo',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['repository.distributionInfoType_model'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'680f522cd96211e5924af04da2da8af8621c80bbc1b74c009acc844530d81230'", 'unique': 'True', 'max_length': '64'}),
