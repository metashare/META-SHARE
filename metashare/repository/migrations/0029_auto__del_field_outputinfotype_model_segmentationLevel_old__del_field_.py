...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'outputInfoType_model.segmentationLevel_old'
        db.delete_column('repository_outputinfotype_model', 'segmentationLevel_old')

        # Deleting field 'annotationInfoType_model.segmentationLevel_old'
        db.delete_column('repository_annotationinfotype_model', 'segmentationLevel_old')

        # Deleting field 'inputInfoType_model.segmentationLevel_old'
        db.delete_column('repository_inputinfotype_model', 'segmentationLevel_old')


    def backwards(self, orm):
        # Adding field 'outputInfoType_model.segmentationLevel_old'
        db.add_column('repository_outputinfotype_model', 'segmentationLevel_old',
                      self.gf('metashare.repository.fields.MultiSelectField')(blank=True, default='', max_length=5, choices=((u'paragraph', u'Paragraph'), (u'sentence', u'Sentence'), (u'clause', u'Clause'), (u'word', u'Word'), (u'wordGroup', u'Word Group'), (u'utterance', u'Utterance'), (u'topic', u'Topic'), (u'signal', u'Signal'), (u'phoneme', u'Phoneme'), (u'syllable', u'Syllable'), (u'phrase', u'Phrase'), (u'diphone', u'Diphone'), (u'prosodicBoundaries', u'Prosodic Boundaries'), (u'frame', u'Frame'), (u'scene', u'Scene'), (u'shot', u'Shot'), (u'other', u'Other'))),
                      keep_default=False)

        # Adding field 'annotationInfoType_model.segmentationLevel_old'
        db.add_column('repository_annotationinfotype_model', 'segmentationLevel_old',
                      self.gf('metashare.repository.fields.MultiSelectField')(blank=True, default='', max_length=5, choices=((u'paragraph', u'Paragraph'), (u'sentence', u'Sentence'), (u'clause', u'Clause'), (u'word', u'Word'), (u'wordGroup', u'Word Group'), (u'utterance', u'Utterance'), (u'topic', u'Topic'), (u'signal', u'Signal'), (u'phoneme', u'Phoneme'), (u'syllable', u'Syllable'), (u'phrase', u'Phrase'), (u'diphone', u'Diphone'), (u'prosodicBoundaries', u'Prosodic Boundaries'), (u'frame', u'Frame'), (u'scene', u'Scene'), (u'shot', u'Shot'), (u'other', u'Other'))),
                      keep_default=False)

        # Adding field 'inputInfoType_model.segmentationLevel_old'
        db.add_column('repository_inputinfotype_model', 'segmentationLevel_old',
                      self.gf('metashare.repository.fields.MultiSelectField')(blank=True, default='', max_length=5, choices=((u'paragraph', u'Paragraph'), (u'sentence', u'Sentence'), (u'clause', u'Clause'), (u'word', u'Word'), (u'wordGroup', u'Word Group'), (u'utterance', u'Utterance'), (u'topic', u'Topic'), (u'signal', u'Signal'), (u'phoneme', u'Phoneme'), (u'syllable', u'Syllable'), (u'phrase', u'Phrase'), (u'diphone', u'Diphone'), (u'prosodicBoundaries', u'Prosodic Boundaries'), (u'frame', u'Frame'), (u'scene', u'Scene'), (u'shot', u'Shot'), (u'other', u'Other'))),
                      keep_default=False)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'e1902474d4c011e5aeaaf04da2da8af82520458fce014dc5b6b59baff11d3b3c'", 'unique': 'True', 'max_length': '64'}),
