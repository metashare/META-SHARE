...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for corpus_video in orm.corpusVideoInfoType_model.objects.iterator():
            if corpus_video.modalityInfo is not None:
                corpus_video.modalityinfotype_model_set.add(corpus_video.modalityInfo)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'3618db94d49e11e59490f04da2da8af82f7d417639094453a5c2accd6c37a0f0'", 'unique': 'True', 'max_length': '64'}),
