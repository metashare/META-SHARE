...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Changing field 'textNumericalFormatInfoType_model.mimeType'
        db.alter_column('repository_textnumericalformatinfotype_model', 'mimeType', self.gf('metashare.repository.fields.XmlCharField')(max_length=1000))

        # Changing field 'textFormatInfoType_model.mimeType'
        db.alter_column('repository_textformatinfotype_model', 'mimeType', self.gf('metashare.repository.fields.XmlCharField')(max_length=50))

        # Changing field 'audioFormatInfoType_model.mimeType'
        db.alter_column('repository_audioformatinfotype_model', 'mimeType', self.gf('metashare.repository.fields.XmlCharField')(max_length=50))

        # Changing field 'videoFormatInfoType_model.mimeType'
        db.alter_column('repository_videoformatinfotype_model', 'mimeType', self.gf('metashare.repository.fields.XmlCharField')(max_length=50))

        # Changing field 'imageFormatInfoType_model.mimeType'
        db.alter_column('repository_imageformatinfotype_model', 'mimeType', self.gf('metashare.repository.fields.XmlCharField')(max_length=50))

        # Deleting field 'outputInfoType_model.mimeType'
        db.delete_column('repository_outputinfotype_model', 'mimeType')

        # Deleting field 'inputInfoType_model.mimeType'
        db.delete_column('repository_inputinfotype_model', 'mimeType')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'4c7ab452d55c11e58011f04da2da8af85b2ae1b54ef74caebc37ff068db748c0'", 'unique': 'True', 'max_length': '64'}),
