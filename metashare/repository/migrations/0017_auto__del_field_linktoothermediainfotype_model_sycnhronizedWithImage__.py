...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'linkToOtherMediaInfoType_model.sycnhronizedWithImage' to 'linkToOtherMediaInfoType_model.synchronizedWithImage'
        db.rename_column('repository_linktoothermediainfotype_model', 'sycnhronizedWithImage', 'synchronizedWithImage')

    def backwards(self, orm):
        # Renaming field 'linkToOtherMediaInfoType_model.synchronizedWithImage' to 'linkToOtherMediaInfoType_model.sycnhronizedWithImage'
        db.rename_column('repository_linktoothermediainfotype_model', 'synchronizedWithImage', 'sycnhronizedWithImage')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'fcf8fafcd4a111e5bc01f04da2da8af8eef49e6c049743d3b007af4d958c8e86'", 'unique': 'True', 'max_length': '64'}),
