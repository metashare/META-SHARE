...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'foreseenUseInfoType_model.useNLPSpecific'
        db.delete_column('repository_foreseenuseinfotype_model', 'useNLPSpecific')

        # Deleting field 'actualUseInfoType_model.useNLPSpecific'
        db.delete_column('repository_actualuseinfotype_model', 'useNLPSpecific')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'636d0a74d4a911e585b1f04da2da8af88c54a4f7768e4197b5a826810f6445be'", 'unique': 'True', 'max_length': '64'}),
