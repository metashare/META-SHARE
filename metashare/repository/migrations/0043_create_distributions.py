...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for resource in orm.resourceInfoType_model.objects.iterator():
            resource.distributioninfotype_model_set.add(resource.distributionInfo)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'38f63c00d96011e58b13f04da2da8af8a1253fd2cab54bc3b9341d9f50ae98d7'", 'unique': 'True', 'max_length': '64'}),
