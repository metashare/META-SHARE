...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'settingInfoType_model.conversationalType'
        db.add_column('repository_settinginfotype_model', 'conversationalType',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'monologue', u'Monologue'), (u'dialogue', u'Dialogue'), (u'multilogue', u'Multilogue')), max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'settingInfoType_model.scenarioType'
        db.add_column('repository_settinginfotype_model', 'scenarioType',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'frogStory', u'Frog Story'), (u'mapTask', u'Map Task'), (u'onlineEducationalGame', u'Online Educational Game'), (u'pearStory', u'Pear Story'), (u'rolePlay', u'Role Play'), (u'wordGame', u'Word Game'), (u'wizardOfOz', u'Wizard Of Oz'), (u'other', u'Other')), max_length=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'settingInfoType_model.conversationalType'
        db.delete_column('repository_settinginfotype_model', 'conversationalType')

        # Deleting field 'settingInfoType_model.scenarioType'
        db.delete_column('repository_settinginfotype_model', 'scenarioType')
    ...
    models = {
        ...
        'repository.settinginfotype_model': {
            ...
            'conversationalType_old': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'scenarioType_old': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'})
        },
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'61a43f8cd49f11e5b09ef04da2da8af817d84f1c8501449aa6847e0af926b34b'", 'unique': 'True', 'max_length': '64'}),
