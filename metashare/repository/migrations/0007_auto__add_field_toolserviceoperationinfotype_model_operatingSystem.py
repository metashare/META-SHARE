...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'toolServiceOperationInfoType_model.operatingSystem'
        db.add_column('repository_toolserviceoperationinfotype_model', 'operatingSystem',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'os-independent', u'Os - Independent'), (u'windows', u'Windows'), (u'linux', u'Linux'), (u'unix', u'Unix'), (u'mac-OS', u'Mac - OS'), (u'googleChromeOS', u'Google ChromeOS'), (u'iOS', u'IOS'), (u'android', u'Android'), (u'other', u'Other'), (u'', u'')), max_length=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'toolServiceOperationInfoType_model.operatingSystem'
        db.delete_column('repository_toolserviceoperationinfotype_model', 'operatingSystem')
    ...
    models = {
        ...
        'repository.toolserviceoperationinfotype_model': {
            ...
            'operatingSystem_old': ('metashare.repository.fields.MultiSelectField', [], {'max_length': '2', 'choices': "((u'os-independent', u'Os - Independent'), (u'windows', u'Windows'), (u'linux', u'Linux'), (u'unix', u'Unix'), (u'mac-OS', u'Mac - OS'), (u'other', u'Other'))"}),
            'runningEnvironmentInfo': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['repository.runningEnvironmentInfoType_model']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'021250e8d49c11e5a95ff04da2da8af8e76feffce21a4eefb8f685d68b1a560b'", 'unique': 'True', 'max_length': '64'}),
