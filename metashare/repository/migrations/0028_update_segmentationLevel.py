...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for annotationinfo in orm.annotationInfoType_model.objects.iterator():
            annotationinfo.segmentationLevel = annotationinfo.segmentationLevel_old
            annotationinfo.save()

        for inputinfo in orm.inputInfoType_model.objects.iterator():
            inputinfo.segmentationLevel = inputinfo.segmentationLevel_old
            inputinfo.save()
        
        for outputinfo in orm.outputInfoType_model.objects.iterator():
            outputinfo.segmentationLevel = outputinfo.segmentationLevel_old
            outputinfo.save()
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'5a944370d4bf11e5aa88f04da2da8af8a57ef5acf37e4168a19451242702ad35'", 'unique': 'True', 'max_length': '64'}),
