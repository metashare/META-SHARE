...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'outputInfoType_model.segmentationLevel'
        db.add_column('repository_outputinfotype_model', 'segmentationLevel',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'paragraph', u'Paragraph'), (u'sentence', u'Sentence'), (u'clause', u'Clause'), (u'word', u'Word'), (u'wordGroup', u'Word Group'), (u'utterance', u'Utterance'), (u'topic', u'Topic'), (u'signal', u'Signal'), (u'phoneme', u'Phoneme'), (u'syllable', u'Syllable'), (u'phrase', u'Phrase'), (u'diphone', u'Diphone'), (u'prosodicBoundaries', u'Prosodic Boundaries'), (u'frame', u'Frame'), (u'scene', u'Scene'), (u'shot', u'Shot'), (u'token', u'Token'), (u'other', u'Other')), max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'annotationInfoType_model.segmentationLevel'
        db.add_column('repository_annotationinfotype_model', 'segmentationLevel',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'paragraph', u'Paragraph'), (u'sentence', u'Sentence'), (u'clause', u'Clause'), (u'word', u'Word'), (u'wordGroup', u'Word Group'), (u'utterance', u'Utterance'), (u'topic', u'Topic'), (u'signal', u'Signal'), (u'phoneme', u'Phoneme'), (u'syllable', u'Syllable'), (u'phrase', u'Phrase'), (u'diphone', u'Diphone'), (u'prosodicBoundaries', u'Prosodic Boundaries'), (u'frame', u'Frame'), (u'scene', u'Scene'), (u'shot', u'Shot'), (u'token', u'Token'), (u'other', u'Other')), max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'inputInfoType_model.segmentationLevel'
        db.add_column('repository_inputinfotype_model', 'segmentationLevel',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', choices=((u'paragraph', u'Paragraph'), (u'sentence', u'Sentence'), (u'clause', u'Clause'), (u'word', u'Word'), (u'wordGroup', u'Word Group'), (u'utterance', u'Utterance'), (u'topic', u'Topic'), (u'signal', u'Signal'), (u'phoneme', u'Phoneme'), (u'syllable', u'Syllable'), (u'phrase', u'Phrase'), (u'diphone', u'Diphone'), (u'prosodicBoundaries', u'Prosodic Boundaries'), (u'frame', u'Frame'), (u'scene', u'Scene'), (u'shot', u'Shot'), (u'token', u'Token'), (u'other', u'Other')), max_length=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'outputInfoType_model.segmentationLevel'
        db.delete_column('repository_outputinfotype_model', 'segmentationLevel')

        # Deleting field 'annotationInfoType_model.segmentationLevel'
        db.delete_column('repository_annotationinfotype_model', 'segmentationLevel')

        # Deleting field 'inputInfoType_model.segmentationLevel'
        db.delete_column('repository_inputinfotype_model', 'segmentationLevel')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'4c663e2ad4bf11e5bad5f04da2da8af8a70f2c00fb6e42e48b1d831e83bfcf54'", 'unique': 'True', 'max_length': '64'}),
