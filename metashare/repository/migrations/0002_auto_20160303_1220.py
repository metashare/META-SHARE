...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ForeignKey(related_name='relation_info_type_set', blank=True, to='repository.resourceInfoType_model', null=True),
        ...
        migrations.AlterField(
            ...
            name='back_to_resourceinfotype_model',
            field=models.ForeignKey(related_name='validation_info_type_set', blank=True, to='repository.resourceInfoType_model', null=True),
            preserve_default=True,
        ),
    ]
