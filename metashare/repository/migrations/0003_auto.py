...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field validationReport on 'validationInfoType_model'
        m2m_table_name = db.shorten_name('repository_validationinfotype_model_validationReport')
        ...
        db.create_unique(m2m_table_name, ['validationinfotype_model_id', 'documentationinfotype_model_id'])

        # Adding M2M table for field validationTool on 'validationInfoType_model'
        m2m_table_name = db.shorten_name('repository_validationinfotype_model_validationTool')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('validationinfotype_model', models.ForeignKey(orm['repository.validationinfotype_model'], null=False)),
            ('targetresourceinfotype_model', models.ForeignKey(orm['repository.targetresourceinfotype_model'], null=False))
        ))
        db.create_unique(m2m_table_name, ['validationinfotype_model_id', 'targetresourceinfotype_model_id'])


    def backwards(self, orm):
        # Removing M2M table for field validationReport on 'validationInfoType_model'
        db.delete_table(db.shorten_name('repository_validationinfotype_model_validationReport'))

        # Removing M2M table for field validationTool on 'validationInfoType_model'
        db.delete_table(db.shorten_name('repository_validationinfotype_model_validationTool'))
    ...
    models = {
        ...
        'repository.validationinfotype_model': {
            ...
            'validationReport_old': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['repository.documentationInfoType_model']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'validationTool_old': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['repository.targetResourceInfoType_model']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'49a6a522d49b11e59c93f04da2da8af809ae3ab4f7114f12a4ed9279cb880a36'", 'unique': 'True', 'max_length': '64'}),
