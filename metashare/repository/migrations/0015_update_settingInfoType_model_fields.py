...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for setting_info in orm.settingInfoType_model.objects.iterator():
            if setting_info.conversationalType_old:
                setting_info.conversationalType = [setting_info.conversationalType_old]
            if setting_info.scenarioType_old:
                setting_info.scenarioType = [setting_info.scenarioType_old]
            setting_info.save()
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'79324c34d49f11e588c0f04da2da8af8e9851b8f363049cdb374dd23025b0f22'", 'unique': 'True', 'max_length': '64'}),
