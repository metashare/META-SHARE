...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'outputInfoType_model.annotationType' to 'inputInfoType_model.annotationType_old'
        db.rename_column('repository_outputinfotype_model', 'annotationType', 'annotationType_old')

        # Renaming field 'inputInfoType_model.annotationType' to 'inputInfoType_model.annotationType_old'
        db.rename_column('repository_inputinfotype_model', 'annotationType', 'annotationType_old')


    def backwards(self, orm):
        # Renaming field 'outputInfoType_model.annotationType_old' to 'inputInfoType_model.annotationType'
        db.rename_column('repository_outputinfotype_model', 'annotationType_old', 'annotationType')

        # Renaming field 'inputInfoType_model.annotationType' to 'inputInfoType_model.annotationType_old'
        db.rename_column('repository_inputinfotype_model', 'annotationType_old', 'annotationType')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'fac4901ad4bb11e599f8f04da2da8af87c14f59856564e2fb14efe6c547e482d'", 'unique': 'True', 'max_length': '64'}),
