...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'annotationInfoType_model.segmentationLevel' to 'annotationInfoType_model.segmentationLevel_old'
        db.rename_column('repository_annotationinfotype_model', 'segmentationLevel', 'segmentationLevel_old')
        
        # Renaming field 'inputInfoType_model.segmentationLevel' to 'inputInfoType_model.segmentationLevel_old'
        db.rename_column('repository_inputinfotype_model', 'segmentationLevel', 'segmentationLevel_old')
        
        # Renaming field 'outputInfoType_model.segmentationLevel' to 'outputInfoType_model.segmentationLevel_old'
        db.rename_column('repository_outputinfotype_model', 'segmentationLevel', 'segmentationLevel_old')


    def backwards(self, orm):
        # Renaming field 'annotationInfoType_model.segmentationLevel_old' to 'annotationInfoType_model.segmentationLevel'
        db.rename_column('repository_annotationinfotype_model', 'segmentationLevel_old', 'segmentationLevel')
        
        # Renaming field 'inputInfoType_model.segmentationLevel_old' to 'inputInfoType_model.segmentationLevel'
        db.rename_column('repository_inputinfotype_model', 'segmentationLevel_old', 'segmentationLevel')
        
        # Renaming field 'outputInfoType_model.segmentationLevel_old' to 'outputInfoType_model.segmentationLevel'
        db.rename_column('repository_outputinfotype_model', 'segmentationLevel_old', 'segmentationLevel')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'4dc5b4a4d4be11e5920ef04da2da8af8d113cc37ab874e11a515937fe861a372'", 'unique': 'True', 'max_length': '64'}),
