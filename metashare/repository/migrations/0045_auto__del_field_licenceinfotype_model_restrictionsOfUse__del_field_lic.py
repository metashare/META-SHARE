...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'licenceInfoType_model.restrictionsOfUse' to 'licenceInfoType_model.restrictionsOfUse_old'
        db.rename_column('repository_licenceinfotype_model', 'restrictionsOfUse', 'restrictionsOfUse_old')
        
        # Rename 'licenceInfoType_model.licence' to 'licenceInfoType_model.licence_old'
        db.rename_column('repository_licenceinfotype_model', 'licence', 'licence_old')

    def backwards(self, orm):
        # Rename 'licenceInfoType_model.restrictionsOfUse_old' to 'licenceInfoType_model.restrictionsOfUse'
        db.rename_column('repository_licenceinfotype_model', 'restrictionsOfUse_old', 'restrictionsOfUse')
        
        # Rename 'licenceInfoType_model.licence_old' to 'licenceInfoType_model.licence'
        db.rename_column('repository_licenceinfotype_model', 'licence_old', 'licence')
    ...
    models = {
        ...
        'repository.communicationinfotype_model': {
            ...
            'email': ('metashare.repository.fields.MultiTextField', [], {'max_length': '1000'}),
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'23ea0b98d96511e5b231f04da2da8af822426630bc364dbbac37809df5fd13d8'", 'unique': 'True', 'max_length': '64'}),
