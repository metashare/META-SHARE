...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for validation_info in orm.validationInfoType_model.objects.iterator():
            if validation_info.validationReport_old is not None:
                validation_info.validationReport.add(validation_info.validationReport_old)
            if validation_info.validationTool_old is not None:
                validation_info.validationTool.add(validation_info.validationTool_old)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'61710b7ad49b11e5a3daf04da2da8af841e451cf9db347e0b0a0b1aaa9c47f77'", 'unique': 'True', 'max_length': '64'}),
