...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'distributionInfoType_model.back_to_resourceinfotype_model'
        db.add_column('repository_distributioninfotype_model', 'back_to_resourceinfotype_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.resourceInfoType_model'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'distributionInfoType_model.back_to_resourceinfotype_model'
        db.delete_column('repository_distributioninfotype_model', 'back_to_resourceinfotype_model_id')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'2d412410d96011e5a01af04da2da8af837d06e60c08040faa3ae0fbedc781c04'", 'unique': 'True', 'max_length': '64'}),
