...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'toolServiceOperationInfoType_model.operatingSystem_old'
        db.delete_column('repository_toolserviceoperationinfotype_model', 'operatingSystem_old')


    def backwards(self, orm):
        # Adding field 'toolServiceOperationInfoType_model.operatingSystem_old'
        db.add_column('repository_toolserviceoperationinfotype_model', 'operatingSystem_old',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', max_length=2, choices=((u'os-independent', u'Os - Independent'), (u'windows', u'Windows'), (u'linux', u'Linux'), (u'unix', u'Unix'), (u'mac-OS', u'Mac - OS'), (u'other', u'Other'))),
                      keep_default=False)
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'44ccfbd6d49c11e5a5f0f04da2da8af87986797f2c0f46ae9a2ca11ea2abb6ae'", 'unique': 'True', 'max_length': '64'}),
