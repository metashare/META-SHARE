...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'foreseenUseInfoType_model.useNLPSpecific' to 'foreseenUseInfoType_model.useNLPSpecific_old'
        db.rename_column('repository_foreseenuseinfotype_model', 'useNLPSpecific', 'useNLPSpecific_old')

        # Renaming field 'actualUseInfoType_model.useNLPSpecific' to 'actualUseInfoType_model.useNLPSpecific_old'
        db.rename_column('repository_actualuseinfotype_model', 'useNLPSpecific', 'useNLPSpecific_old')


    def backwards(self, orm):
        # Renaming field 'foreseenUseInfoType_model.useNLPSpecific_old' to 'foreseenUseInfoType_model.useNLPSpecific'
        db.rename_column('repository_foreseenuseinfotype_model', 'useNLPSpecific_old', 'useNLPSpecific')

        # Renaming field 'actualUseInfoType_model.useNLPSpecific_old' to 'actualUseInfoType_model.useNLPSpecific'
        db.rename_column('repository_actualuseinfotype_model', 'useNLPSpecific_old', 'useNLPSpecific')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'a6c56e20d4a811e58911f04da2da8af8f7bfd51466014336b59044fe558160c1'", 'unique': 'True', 'max_length': '64'}),
