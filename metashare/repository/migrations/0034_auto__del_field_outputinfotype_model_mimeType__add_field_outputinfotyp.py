...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'outputInfoType_model.mimeType' to 'outputInfoType_model.mimeType_old'
        db.rename_column('repository_outputinfotype_model', 'mimeType', 'mimeType_old')
        
        # Renaming field 'inputInfoType_model.mimeType' to 'inputInfoType_model.mimeType_old'
        db.rename_column('repository_inputinfotype_model', 'mimeType', 'mimeType_old')


    def backwards(self, orm):
        # Renaming field 'outputInfoType_model.mimeType_old' to 'outputInfoType_model.mimeType'
        db.rename_column('repository_outputinfotype_model', 'mimeType_old', 'mimeType')
        
        # Renaming field 'inputInfoType_model.mimeType_old' to 'inputInfoType_model.mimeType'
        db.rename_column('repository_inputinfotype_model', 'mimeType_old', 'mimeType')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'bbdc7534d55b11e59f59f04da2da8af80c49f1c2c25347979bc5cce1229690ba'", 'unique': 'True', 'max_length': '64'}),
