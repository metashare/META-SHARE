...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'validationInfoType_model.validationTool' to 'validationInfoType_model.validationTool_old'
        db.rename_column('repository_validationinfotype_model', 'validationTool_id', 'validationTool_old_id')
        
        # Renaming field 'validationInfoType_model.validationReport' to 'validationInfoType_model.validationReport_old'
        db.rename_column('repository_validationinfotype_model', 'validationReport_id', 'validationReport_old_id')

    def backwards(self, orm):
        # Renaming field 'validationInfoType_model.validationTool_old' to 'validationInfoType_model.validationTool'
        db.rename_column('repository_validationinfotype_model', 'validationTool_id', 'validationTool_old_id')
        
        # Renaming field 'validationInfoType_model.validationReport_old' to 'validationInfoType_model.validationReport'
        db.rename_column('repository_validationinfotype_model', 'validationReport_id', 'validationReport_old_id')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'09360474d49b11e59fc5f04da2da8af84136e96bf3464f7fba880290702b5156'", 'unique': 'True', 'max_length': '64'}),
