...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for documentUnstructured_old in orm.documentUnstructuredString_model_old.objects.iterator():
            orm.documentUnstructuredString_model.objects.create(pk=documentUnstructured_old.documentationinfotype_model_ptr.pk,value=documentUnstructured_old.value)

        dbbackend = settings.DATABASES['default']['ENGINE']
        if orm.documentationInfoType_model.objects.count() > 0:
            highest_number = orm.documentationInfoType_model.objects.latest('pk').pk
            if dbbackend == "django.db.backends.postgresql_psycopg2":
                db.execute('select setval(\'repository_documentationinfotype_model_id_seq\', %s);' % (highest_number + 1))
            elif dbbackend == "django.db.backends.mysql":
                try:
                    db.execute('ALTER TABLE repository_documentunstructuredstring_model AUTO_INCREMENT = %s;' % (highest_number + 1))
                except:
                    pass
            elif dbbackend == "django.db.backends.sqlite3":
                try:
                    db.execute('UPDATE SQLITE_SEQUENCE SET seq = %s WHERE name = \'repository_documentunstructuredstring_model\'' % highest_number)
                except:
                    pass
    ...
    models = {
        ...
        'repository.documentunstructuredstring_model': {
            'Meta': {'object_name': 'documentUnstructuredString_model', '_ormbases': ['repository.documentationInfoType_model']},
            'documentationinfotype_model_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['repository.documentationInfoType_model']", 'unique': 'True', 'primary_key': 'True'}),
            'value': ('django.db.models.fields.TextField', [], {})
        },
        'repository.documentunstructuredstring_model_old': {
            'Meta': {'object_name': 'documentUnstructuredString_model_old', '_ormbases': ['repository.InvisibleStringModel', 'repository.documentationInfoType_model']},
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'9d30832254cd11e687cdf04da2da8af85d798dbd2dbd45eea27c00464c444682'", 'unique': 'True', 'max_length': '64'}),
            'local_storage': ('django.db.models.fields.TextField', [], {'default': "'not set yet'"}),
            'metadata': ('django.db.models.fields.TextField', [], {}),
            'metashare_version': ('django.db.models.fields.CharField', [], {'default': "'3.1'", 'max_length': '32'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 28, 0, 0)'}),
