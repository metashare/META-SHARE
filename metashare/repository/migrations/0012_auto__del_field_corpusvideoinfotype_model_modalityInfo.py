...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming 'settingInfoType_model.scenarioType' to 'settingInfoType_model.scenarioType_old'
        db.rename_column('repository_settinginfotype_model', 'scenarioType', 'scenarioType_old')

        # Renaming 'settingInfoType_model.conversationalType' to 'settingInfoType_model.conversationalType_old'
        db.rename_column('repository_settinginfotype_model', 'conversationalType', 'conversationalType_old')


    def backwards(self, orm):
        # Renaming 'settingInfoType_model.scenarioType_old' to 'settingInfoType_model.scenarioType'
        db.rename_column('repository_settinginfotype_model', 'scenarioType_old', 'scenarioType')

        # Renaming 'settingInfoType_model.conversationalType_old' to 'settingInfoType_model.conversationalType'
        db.rename_column('repository_settinginfotype_model', 'conversationalType_old', 'conversationalType')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'a9a52068d49e11e5ba17f04da2da8af890eb363bf28242998631b311066c6498'", 'unique': 'True', 'max_length': '64'}),
