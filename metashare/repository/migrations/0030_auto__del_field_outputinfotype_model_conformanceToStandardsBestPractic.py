...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'outputInfoType_model.conformanceToStandardsBestPractices' to 'outputInfoType_model.conformanceToStandardsBestPractices_old'
        db.rename_column('repository_outputinfotype_model', 'conformanceToStandardsBestPractices', 'conformanceToStandardsBestPractices_old')

        # Renaming field 'languageDescriptionEncodingInfoType_model.conformanceToStandardsBestPractices' to 'languageDescriptionEncodingInfoType_model.conformanceToStandardsBestPractices_old'
        db.rename_column('repository_languagedescriptionencodinginfotype_model', 'conformanceToStandardsBestPractices', 'conformanceToStandardsBestPractices_old')

        # Renaming field 'annotationInfoType_model.conformanceToStandardsBestPractices' to 'annotationInfoType_model.conformanceToStandardsBestPractices_old'
        db.rename_column('repository_annotationinfotype_model', 'conformanceToStandardsBestPractices', 'conformanceToStandardsBestPractices_old')
        
        # Renaming field 'inputInfoType_model.conformanceToStandardsBestPractices' to 'inputInfoType_model.conformanceToStandardsBestPractices_old'
        db.rename_column('repository_inputinfotype_model', 'conformanceToStandardsBestPractices', 'conformanceToStandardsBestPractices_old')

        # Renaming field 'lexicalConceptualResourceEncodingInfoType_model.conformanceToStandardsBestPractices' to 'lexicalConceptualResourceEncodingInfoType_model.conformanceToStandardsBestPractices_old'
        db.rename_column('repository_lexicalconceptualresourceencodinginfotype_model', 'conformanceToStandardsBestPractices', 'conformanceToStandardsBestPractices_old')


    def backwards(self, orm):
        # Renaming field 'outputInfoType_model.conformanceToStandardsBestPractices_old' to 'outputInfoType_model.conformanceToStandardsBestPractices'
        db.rename_column('repository_outputinfotype_model', 'conformanceToStandardsBestPractices_old', 'conformanceToStandardsBestPractices')

        # Renaming field 'languageDescriptionEncodingInfoType_model.conformanceToStandardsBestPractices_old' to 'languageDescriptionEncodingInfoType_model.conformanceToStandardsBestPractices'
        db.rename_column('repository_languagedescriptionencodinginfotype_model', 'conformanceToStandardsBestPractices_old', 'conformanceToStandardsBestPractices')

        # Renaming field 'annotationInfoType_model.conformanceToStandardsBestPractices_old' to 'annotationInfoType_model.conformanceToStandardsBestPractices'
        db.rename_column('repository_annotationinfotype_model', 'conformanceToStandardsBestPractices_old', 'conformanceToStandardsBestPractices')
        
        # Renaming field 'inputInfoType_model.conformanceToStandardsBestPractices_old' to 'inputInfoType_model.conformanceToStandardsBestPractices'
        db.rename_column('repository_inputinfotype_model', 'conformanceToStandardsBestPractices_old', 'conformanceToStandardsBestPractices')

        # Renaming field 'lexicalConceptualResourceEncodingInfoType_model.conformanceToStandardsBestPractices_old' to 'lexicalConceptualResourceEncodingInfoType_model.conformanceToStandardsBestPractices'
        db.rename_column('repository_lexicalconceptualresourceencodinginfotype_model', 'conformanceToStandardsBestPractices_old', 'conformanceToStandardsBestPractices')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'78670a7ad4c111e593bef04da2da8af872e98dd065a84f19970c6865cdc3d5a3'", 'unique': 'True', 'max_length': '64'}),
