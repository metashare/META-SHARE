...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'validationInfoType_model.validationTool_old'
        db.delete_column('repository_validationinfotype_model', 'validationTool_old_id')

        # Deleting field 'validationInfoType_model.validationReport_old'
        db.delete_column('repository_validationinfotype_model', 'validationReport_old_id')


    def backwards(self, orm):
        # Adding field 'validationInfoType_model.validationTool_old'
        db.add_column('repository_validationinfotype_model', 'validationTool_old',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.targetResourceInfoType_model'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'validationInfoType_model.validationReport_old'
        db.add_column('repository_validationinfotype_model', 'validationReport_old',
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'85ebb112d49b11e59e96f04da2da8af8ff7d33f03d3649b08e8e0c95948f4f6b'", 'unique': 'True', 'max_length': '64'}),
