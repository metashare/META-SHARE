...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'communicationInfoType_model.countryId'
        db.add_column('repository_communicationinfotype_model', 'countryId',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'projectInfoType_model.fundingCountryId'
        db.add_column('repository_projectinfotype_model', 'fundingCountryId',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'communicationInfoType_model.countryId'
        db.delete_column('repository_communicationinfotype_model', 'countryId')

        # Deleting field 'projectInfoType_model.fundingCountryId'
        db.delete_column('repository_projectinfotype_model', 'fundingCountryId')
    ...
    models = {
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'341b1210d93711e580acf04da2da8af805b8ed94cd1249548d8f1911d2fe480b'", 'unique': 'True', 'max_length': '64'}),
