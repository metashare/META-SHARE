...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'outputInfoType_model.mimeType_old'
        db.delete_column('repository_outputinfotype_model', 'mimeType_old')

        # Deleting field 'inputInfoType_model.mimeType_old'
        db.delete_column('repository_inputinfotype_model', 'mimeType_old')


    def backwards(self, orm):
        # Adding field 'outputInfoType_model.mimeType_old'
        db.add_column('repository_outputinfotype_model', 'mimeType_old',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'inputInfoType_model.mimeType_old'
        db.add_column('repository_inputinfotype_model', 'mimeType_old',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=50, blank=True),
                      keep_default=False)
