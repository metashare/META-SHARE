...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'licenceInfoType_model.fee'
        db.delete_column('repository_licenceinfotype_model', 'fee')

        # Deleting field 'licenceInfoType_model.licence_old'
        db.delete_column('repository_licenceinfotype_model', 'licence_old')

        # Deleting field 'licenceInfoType_model.userNature'
        db.delete_column('repository_licenceinfotype_model', 'userNature')

        # Deleting field 'licenceInfoType_model.attributionText'
        db.delete_column('repository_licenceinfotype_model', 'attributionText')

        # Deleting field 'licenceInfoType_model.restrictionsOfUse_old'
        db.delete_column('repository_licenceinfotype_model', 'restrictionsOfUse_old')

        # Deleting field 'licenceInfoType_model.back_to_distributioninfotype_model'
        db.delete_column('repository_licenceinfotype_model', 'back_to_distributioninfotype_model_id')

        # Deleting field 'licenceInfoType_model.downloadLocation'
        db.delete_column('repository_licenceinfotype_model', 'downloadLocation')

        # Deleting field 'licenceInfoType_model.executionLocation'
        db.delete_column('repository_licenceinfotype_model', 'executionLocation')
        ...
        # Adding field 'resourceDocumentationInfoType_model.citation'
        db.add_column('repository_resourcedocumentationinfotype_model', 'citation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.documentationInfoType_model'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
        ...
        # Changing field 'textClassificationInfoType_model.register'
        db.alter_column('repository_textclassificationinfotype_model', 'register', self.gf('metashare.repository.fields.XmlCharField')(max_length=1000))

        # Changing field 'audioClassificationInfoType_model.register'
        db.alter_column('repository_audioclassificationinfotype_model', 'register', self.gf('metashare.repository.fields.XmlCharField')(max_length=1000))

        # Adding field 'metadataInfoType_model.sourceRepository'
        db.add_column('repository_metadatainfotype_model', 'sourceRepository',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


        # Changing field 'videoClassificationInfoType_model.subject_topic'
        db.alter_column('repository_videoclassificationinfotype_model', 'subject_topic', self.gf('metashare.repository.fields.XmlCharField')(max_length=500))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'licenceInfoType_model.fee'
        db.add_column('repository_licenceinfotype_model', 'fee',
                      self.gf('metashare.repository.fields.XmlCharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.licence_old'
        db.add_column('repository_licenceinfotype_model', 'licence_old',
                      self.gf('metashare.repository.fields.MultiSelectField')(default='', max_length=10, choices=((u'CC-BY', u'CC - BY'), (u'CC-BY-NC', u'CC - BY - NC'), (u'CC-BY-NC-ND', u'CC - BY - NC - ND'), (u'CC-BY-NC-SA', u'CC - BY - NC - SA'), (u'CC-BY-ND', u'CC - BY - ND'), (u'CC-BY-SA', u'CC - BY - SA'), (u'CC-ZERO', u'CC - ZERO'), (u'MS-C-NoReD', u'MS - C - No ReD'), (u'MS-C-NoReD-FF', u'MS - C - No ReD - FF'), (u'MS-C-NoReD-ND', u'MS - C - No ReD - ND'), (u'MS-C-NoReD-ND-FF', u'MS - C - No ReD - ND - FF'), (u'MS-NC-NoReD', u'MS - NC - No ReD'), (u'MS-NC-NoReD-FF', u'MS - NC - No ReD - FF'), (u'MS-NC-NoReD-ND', u'MS - NC - No ReD - ND'), (u'MS-NC-NoReD-ND-FF', u'MS - NC - No ReD - ND - FF'), (u'MSCommons-BY', u'MS Commons - BY'), (u'MSCommons-BY-NC', u'MS Commons - BY - NC'), (u'MSCommons-BY-NC-ND', u'MS Commons - BY - NC - ND'), (u'MSCommons-BY-NC-SA', u'MS Commons - BY - NC - SA'), (u'MSCommons-BY-ND', u'MS Commons - BY - ND'), (u'MSCommons-BY-SA', u'MS Commons - BY - SA'), (u'CLARIN_ACA', u'CLARIN_ACA'), (u'CLARIN_ACA-NC', u'CLARIN_ACA - NC'), (u'CLARIN_PUB', u'CLARIN_PUB'), (u'CLARIN_RES', u'CLARIN_RES'), (u'ELRA_END_USER', u'ELRA_END_USER'), (u'ELRA_EVALUATION', u'ELRA_EVALUATION'), (u'ELRA_VAR', u'ELRA_VAR'), (u'AGPL', u'AGPL'), (u'ApacheLicence_2.0', u'Apache Licence_2.0'), (u'BSD', u'BSD'), (u'BSD-style', u'BSD - Style'), (u'GFDL', u'GFDL'), (u'GPL', u'GPL'), (u'LGPL', u'LGPL'), (u'Princeton_Wordnet', u'Princeton_ Wordnet'), (u'proprietary', u'Proprietary'), (u'underNegotiation', u'Under Negotiation'), (u'other', u'Other'))),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.userNature'
        db.add_column('repository_licenceinfotype_model', 'userNature',
                      self.gf('metashare.repository.fields.MultiSelectField')(blank=True, default='', max_length=1, choices=((u'academic', u'Academic'), (u'commercial', u'Commercial'))),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.attributionText'
        db.add_column('repository_licenceinfotype_model', 'attributionText',
                      self.gf('metashare.repository.fields.DictField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.restrictionsOfUse_old'
        db.add_column('repository_licenceinfotype_model', 'restrictionsOfUse_old',
                      self.gf('metashare.repository.fields.MultiSelectField')(blank=True, default='', max_length=3, choices=((u'informLicensor', u'Inform Licensor'), (u'redeposit', u'Redeposit'), (u'onlyMSmembers', u'OnlyM Smembers'), (u'academic-nonCommercialUse', u'Academic - Non Commercial Use'), (u'evaluationUse', u'Evaluation Use'), (u'commercialUse', u'Commercial Use'), (u'attribution', u'Attribution'), (u'shareAlike', u'Share Alike'), (u'noDerivatives', u'No Derivatives'), (u'noRedistribution', u'No Redistribution'), (u'other', u'Other'))),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.back_to_distributioninfotype_model'
        db.add_column('repository_licenceinfotype_model', 'back_to_distributioninfotype_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.distributionInfoType_model'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.downloadLocation'
        db.add_column('repository_licenceinfotype_model', 'downloadLocation',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'licenceInfoType_model.executionLocation'
        db.add_column('repository_licenceinfotype_model', 'executionLocation',
                      self.gf('metashare.repository.fields.MultiTextField')(default='', max_length=1000, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'resourceDocumentationInfoType_model.citation'
        db.delete_column('repository_resourcedocumentationinfotype_model', 'citation_id')


        # Deleting field 'inputInfoType_model.domain'
        db.delete_column('repository_inputinfotype_model', 'domain')

        # Changing field 'textClassificationInfoType_model.register'
        db.alter_column('repository_textclassificationinfotype_model', 'register', self.gf('metashare.repository.fields.XmlCharField')(max_length=500))

        # Changing field 'audioClassificationInfoType_model.register'
        db.alter_column('repository_audioclassificationinfotype_model', 'register', self.gf('metashare.repository.fields.XmlCharField')(max_length=500))

        # Deleting field 'metadataInfoType_model.sourceRepository'
        db.delete_column('repository_metadatainfotype_model', 'sourceRepository')


        # Changing field 'videoClassificationInfoType_model.subject_topic'
        db.alter_column('repository_videoclassificationinfotype_model', 'subject_topic', self.gf('metashare.repository.fields.XmlCharField')(max_length=1000))
    ...
    models = {
        ...
        'repository.annotationinfotype_model': {
            ...
            'conformanceToStandardsBestPractices': ('metashare.repository.fields.MultiSelectField', [], {'choices': "((u'BML', u'BML'), (u'CES', u'CES'), (u'EAGLES', u'EAGLES'), (u'EML', u'EML'), (u'EMMA', u'EMMA'), (u'GMX', u'GMX'), (u'GrAF', u'GrAF'), (u'HamNoSys', u'Ham No Sys'), (u'InkML', u'InkML'), (u'ILSP_NLP', u'ILSP NLP'), (u'ISO12620', u'ISO12620'), (u'ISO16642', u'ISO16642'), (u'ISO1987', u'ISO1987'), (u'ISO26162', u'ISO26162'), (u'ISO30042', u'ISO30042'), (u'ISO704', u'ISO704'), (u'LAF', u'LAF'), (u'LMF', u'LMF'), (u'MAF', u'MAF'), (u'MLIF', u'MLIF'), (u'MOSES', u'MOSES'), (u'MULTEXT', u'MULTEXT'), (u'MUMIN', u'MUMIN'), (u'multimodalInteractionFramework', u'Multimodal Interaction Framework'), (u'OAXAL', u'OAXAL'), (u'OWL', u'OWL'), (u'PANACEA', u'PANACEA'), (u'pennTreeBank', u'Penn Tree Bank'), (u'pragueTreebank', u'Prague Treebank'), (u'RDF', u'RDF'), (u'SemAF', u'SemAF'), (u'SemAF_DA', u'SemAF DA'), (u'SemAF_NE', u'SemAF NE'), (u'SemAF_SRL', u'SemAF SRL'), (u'SemAF_DS', u'SemAF DS'), (u'SKOS', u'SKOS'), (u'SRX', u'SRX'), (u'SynAF', u'SynAF'), (u'TBX', u'TBX'), (u'TMX', u'TMX'), (u'TEI', u'TEI'), (u'TEI_P3', u'TEI P3'), (u'TEI_P4', u'TEI P4'), (u'TEI_P5', u'TEI P5'), (u'TimeML', u'TimeML'), (u'XCES', u'XCES'), (u'XLIFF', u'XLIFF'), (u'WordNet', u'Word Net'), (u'other', u'Other'))", 'max_length': '13', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'repository.audioclassificationinfotype_model': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'register': ('metashare.repository.fields.XmlCharField', [], {'max_length': '1000', 'blank': 'True'}),
        ...
        'repository.audioformatinfotype_model': {
            ...
            'signalEncoding': ('metashare.repository.fields.MultiSelectField', [], {'choices': "((u'aLaw', u'A Law'), (u'linearPCM', u'LinearPCM'), (u'\\u03bc-law', u'\\u039c - Law'), (u'ADPCM', u'ADPCM'), (u'other', u'Other'))", 'max_length': '2', 'blank': 'True'}),
        ...
        'repository.distributioninfotype_model': {
            ...
            'distributionRightsHolder': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'distributionRightsHolder_distributioninfotype_model_related'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['repository.actorInfoType_model']"}),
            ...
            'licenceInfo': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'licenceInfo_distributioninfotype_model_related'", 'symmetrical': 'False', 'to': "orm['repository.licenceInfoType_model']"}),
            'licensor': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'licensor_distributioninfotype_model_related'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['repository.actorInfoType_model']"}),
            'membershipInfo': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'membershipInfo_distributioninfotype_model_related'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['repository.membershipInfoType_model']"}),
        ...
        'repository.identificationinfotype_model': {
            'ISLRN': ('metashare.repository.fields.XmlCharField', [], {'max_length': '17', 'blank': 'True'}),
        ...
        'repository.licenceinfotype_model': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'licence': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'repository.metadatainfotype_model': {
            ...
            'sourceRepository': ('metashare.repository.fields.XmlCharField', [], {'max_length': '1000', 'blank': 'True'})
        },
        ...
        'repository.resourcedocumentationinfotype_model': {
            ...
            'citation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['repository.documentationInfoType_model']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        'storage.storageobject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'732ac9b0eb8311e59442f04da2da8af86ad6cfdef66e4ab1924f91174d54c661'", 'unique': 'True', 'max_length': '64'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 16, 0, 0)'}),
