...
from metashare.repository.editor.superadmin import SchemaModelAdmin, SchemaModelInline
from metashare.repository.editor.superadmin import is_inline, decode_inline
...
class ReverseModelAdmin(SchemaModelAdmin):
    ...
    #
    # change_form_template = "admin/repository/change_form.html"
    no_inlines = []
