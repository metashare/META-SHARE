...
<xsl:stylesheet version="1.0" xmlns:ms="http://www.ilsp.gr/META-XMLSchema" xmlns:xslt="http://xml.apache.org/xsltm" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xslt xsl">
