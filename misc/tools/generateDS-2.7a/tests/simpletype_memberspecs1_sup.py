...
class SpecialDate(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='pl:', name_='SpecialDate', fromsubclass_=False):
        pass
...
class ExtremeDate(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='pl:', name_='ExtremeDate', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
