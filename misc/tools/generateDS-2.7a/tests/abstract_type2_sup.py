...
class carrierType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='target:', name_='carrierType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='target:', name_='carrierType'):
        pass
    def exportChildren(self, outfile, level, namespace_='target:', name_='carrierType', fromsubclass_=False):
        for fleet_ in self.get_fleet():
            fleet_.export(outfile, level, namespace_, name_='fleet')
...
class Vehicle(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='target:', name_='Vehicle', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='target:', name_='Vehicle'):
        ...
        pass
    def exportChildren(self, outfile, level, namespace_='target:', name_='Vehicle', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
...
class Car(Vehicle):
    ...
    factory = staticmethod(factory)
    def export(self, outfile, level, namespace_='target:', name_='Car', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='target:', name_='Car', fromsubclass_=False):
        super(Car, self).exportChildren(outfile, level, namespace_, name_, True)
        pass
    def hasContent_(self):
        if (
...
class Plane(Vehicle):
    ...
    factory = staticmethod(factory)
    def export(self, outfile, level, namespace_='target:', name_='Plane', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='target:', name_='Plane', fromsubclass_=False):
        super(Plane, self).exportChildren(outfile, level, namespace_, name_, True)
        pass
    def hasContent_(self):
        if (
